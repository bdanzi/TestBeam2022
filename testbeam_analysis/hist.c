...
void hist(){
	...
	for(int i =4; i<=14; ++i){
		...
		leg->Draw();
		c1->Print(Form("/lustrehome/bdanzi/offline_analysis/testbeam_analysis/Plots/%s/H%i_minvalue.png",fname.Data(),i), "png");
	...
	c2->Print(Form("/lustrehome/bdanzi/offline_analysis/testbeam_analysis/Plots/%s/MeanSigmaFlt.png",fname.Data()), "png");
	ca->Print(Form("/lustrehome/bdanzi/offline_analysis/testbeam_analysis/Plots/%s/MeanSigmaOrg.png",fname.Data()), "png");
	c3->Print(Form("/lustrehome/bdanzi/offline_analysis/testbeam_analysis/Plots/%s/RatioMeanvsSigma.png",fname.Data()), "png");
	...
	c4->Print(Form("/lustrehome/bdanzi/offline_analysis/testbeam_analysis/Plots/%s/Ratio_FltWavevsOrgWave_signal.png",fname.Data()), "png");
	...
	cerr->Print(Form("/lustrehome/bdanzi/offline_analysis/testbeam_analysis/Plots/%s/Err.png",fname.Data()), "png");
