...
struct hstPerCh { //istogrammi per tutti i canali dell'oscilloscopio.
  ...
  hstPerCh(int Run_number=0, int Ch=0, int isChannel_1cm=0, int isChannel_2cm=0, int isChannel_1p5cm = 0, float alpha = 0., float _gsample= 0., int isRuns_80_20 = 0, int isRuns_90_10 = 0, int isRuns_85_15= 0) {
    ...
    if(isChannel_2cm || isChannel_1p5cm){
      hNPeaks = new TH1F (Form("hNPeaks_ch%d",Ch),Form("N Electron Peaks found - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d" ,Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),200,0.,200);
    }
    hNPeaks_clust = new TH1F (Form("hNPeaks_clust_ch%d",Ch),Form("N Cluster Peaks found - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d" ,Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),100,0.,100);
    hNeventSignals = new TH1F (Form("hNeventSignals_ch%d",Ch),Form("N event Signals - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d" ,Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),2,-0.5,1.5); 
    hNElectrons_per_cluster = new TH1F (Form("hNElectrons_per_cluster_ch%d",Ch),Form("N Electrons per Each Cluster found - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d" ,Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),10,0.,10);
    hHPeaks = new TH1F (Form("hHPeaks_ch%d",Ch),Form("Height of Electron Peaks found - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d" ,Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),250,0,0.250);
    hHNPeaks = new TH2F (Form("hHNPeaks_ch%d",Ch),Form("Time of Electron [ith] vs Difference in Time of Electrons Found [ith +1] - [ith]   - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d",Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),250,0,600,100,0,50);
    if(isChannel_1cm){
      hNPeakFPeak = new TH2F (Form("hNPeakFPeak_ch%d",Ch),Form("N of Electrons found vs T of First Electron found - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d" ,Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),150,0,300,250,0,250);
    }
    if(isChannel_2cm || isChannel_1p5cm){
      hNPeakFPeak = new TH2F (Form("hNPeakFPeak_ch%d",Ch),Form("N of Electrons found vs T of First Electron found - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d" ,Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),150,0,600,250,0,250);
    }
    if(isChannel_1cm){
	    hNClusterFCluster = new TH2F (Form("hNClusterFCluster_ch%d",Ch),Form("N of Clusters found vs T of First Cluster found - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d" ,Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),100,0,300,100,0,100);
    }
    if(isChannel_2cm || isChannel_1p5cm){
	    hNClusterFCluster = new TH2F (Form("hNClusterFCluster_ch%d",Ch),Form("N of Clusters found vs T of First Cluster found - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d" ,Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),100,0,600,100,0,100);
    }
    hTPeaks = new TH1F (Form("hTPeaks_ch%d",Ch),Form("Time of Electron Peaks found - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d" ,Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),400,0,800);
    if(isChannel_1cm){
	    hTFstPeaks = new TH1F (Form("hTFstPeaks_ch%d",Ch),Form("Time of First Electron Peak found - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d" ,Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),200,0,400);
    }
    if(isChannel_2cm || isChannel_1p5cm){
      hTFstPeaks = new TH1F (Form("hTFstPeaks_ch%d",Ch),Form("Time of First Electron Peak found - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d" ,Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),200,0,800);
    }
    if(isChannel_1cm){
	    hNPeaks_1 = new TH1F (Form("hNPeaks_1_ch%d",Ch),Form("Time of Last Electron Peak found - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d" ,Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),100,0,500);
    }
    if(isChannel_2cm || isChannel_1p5cm){
      hNPeaks_1 = new TH1F (Form("hNPeaks_1_ch%d",Ch),Form("Time of Last Electron Peak found - Run %d - Ch %d - Sense Wire Diameter %d um - Cell Size %0.1f cm - Track Angle %0.1f - %0.1f GSa/s - Gas Mixture 80/20 %d - 90/10 %d - 85/15 %d" ,Run_number,Ch, ChannelDiameter[Ch],ChannelCellSize[Ch], alpha, _gsample, isRuns_80_20, isRuns_90_10, isRuns_85_15),200,0,800);
    }
    ...
    hHNPeaks->GetXaxis()->SetTitle("Time of Electron Peaks found [ns]");
    hHNPeaks->GetYaxis()->SetTitle("Difference in Time of Electron Peaks found");
