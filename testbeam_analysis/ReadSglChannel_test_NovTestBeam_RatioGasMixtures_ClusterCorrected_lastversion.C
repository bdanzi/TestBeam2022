...
void ReadSglChannel_test_NovTestBeam_RatioGasMixtures_ClusterCorrected_lastversion(){
  ...
  bool isRatioSummaryPlots = true;
  bool isEfficiencyPlot = false;
  bool isLogarithm = true;
  bool doFits = true;
  bool savePlot_effsummary = true;
  bool isNov2021TestBeam = false;
  bool isJuly2022TestBeam = true;
  bool isScanAngleStudy = false;
  bool isScanHVStudy = true;
  bool isGasMixtureStudy = false;
  bool isScanSamplingStudy = false;
  
  //   if(isNov2021TestBeam){tubes.Data() = "2";}
  //else if(isJuly2022TestBeam)
  //{
  TString tubes("1.5");
  TString energy_momentum("180 GeV");
  //}
  
  Float_t alpha= 0.;
  Int_t highvoltage= 0;
  Int_t percentageIsoB= 0;
  Float_t cos_alpha = 0.;
  ...
  if ((isScanSamplingStudy) && isJuly2022TestBeam){ number_of_graphs_summary = 3;}
  TCanvas *aveph_summary_1cm = new TCanvas("aveph_summary_1cm",Form("Aveph 1 cm cell size Drift Tubes %s",energy_momentum.Data()),600,600);
  TCanvas *aveph_summary_2cm = new TCanvas("aveph_summary_2cm",Form("Aveph %s cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()),600,600);
  ...
  gr_aveph_summary_2cm->SetTitle(Form("Aveph %s cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()));

  if(isScanAngleStudy){
    gr_aveph_summary_2cm->GetXaxis()->SetTitle("Track angle (deg)");
  }
  else if(isScanHVStudy){
    gr_aveph_summary_2cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
  }
  else if(isScanSamplingStudy){
    gr_aveph_summary_2cm->GetXaxis()->SetTitle("Sampling Rate (GSa/s)");
  }
  else if(isGasMixtureStudy){
    gr_aveph_summary_2cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
  }
  gr_aveph_summary_2cm->GetYaxis()->SetTitle("Average Pulse height (V)");
  
  gr_aveph_summary_1cm->SetTitle(Form("Aveph 1 cm cell size Drift Tubes %s",energy_momentum.Data()));
  ...
  if(isScanAngleStudy){
    ...
    gr_aveph_summary_1cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
  }
  else if(isScanSamplingStudy){
    gr_aveph_summary_1cm->GetXaxis()->SetTitle("Sampling Rate (GSa/s)");
  }
  else if(isGasMixtureStudy){
    gr_aveph_summary_1cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
  }
  
  TCanvas *rms_summary_1cm = new TCanvas("rms_summary_1cm",Form("Rms 1 cm cell size Drift Tubes %s",energy_momentum.Data()),600,600);
  TCanvas *rms_summary_2cm = new TCanvas("rms_summary_2cm",Form("Rms %s cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()),600,600);
  ...
  gr_rms_summary_2cm->SetTitle(Form("Rms %s cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()));

  if(isScanAngleStudy){
    gr_rms_summary_2cm->GetXaxis()->SetTitle("Track angle (deg)");
  }
  else if(isScanHVStudy){
    gr_rms_summary_2cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
  }
  else if(isScanSamplingStudy){
    gr_rms_summary_2cm->GetXaxis()->SetTitle("Sampling Rate (GSa/s)");
  }
  else if(isGasMixtureStudy){
    gr_rms_summary_2cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
  }
  gr_rms_summary_2cm->GetYaxis()->SetTitle("Rms (mV)");
  gr_rms_summary_1cm->SetTitle(Form("Rms 1 cm cell size Drift Tubes %s",energy_momentum.Data()));
  ...
  if(isScanAngleStudy){
    ...
    gr_rms_summary_1cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
  }
  else if(isScanSamplingStudy){
  gr_rms_summary_1cm->GetXaxis()->SetTitle("Sampling Rate (GSa/s)");
  }
  else if(isGasMixtureStudy){
    gr_rms_summary_1cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
  }
  
  TCanvas *bsl_summary_1cm = new TCanvas("bsl_summary_1cm",Form("Bsl 1 cm cell size Drift Tubes %s",energy_momentum.Data()),600,600);
  ...
  gr_bsl_summary_2cm->SetTitle(Form("Bsl %s cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()));

  if(isScanAngleStudy){
    gr_bsl_summary_2cm->GetXaxis()->SetTitle("Track angle (deg)");
  }
  else if(isScanHVStudy){
    gr_bsl_summary_2cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
  }
  else if(isScanSamplingStudy){
    gr_bsl_summary_2cm->GetXaxis()->SetTitle("Sampling Rate (GSa/s)");
  }
  else if(isGasMixtureStudy){
    gr_bsl_summary_2cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
  }
  gr_bsl_summary_2cm->GetYaxis()->SetTitle("Baseline (V)");
  gr_bsl_summary_1cm->SetTitle(Form("Bsl 1 cm cell size Drift Tubes %s",energy_momentum.Data()));
  ...
  if(isScanAngleStudy){
    ...
    gr_bsl_summary_1cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
  }
  else if(isScanSamplingStudy){
    gr_bsl_summary_1cm->GetXaxis()->SetTitle("Sampling Rate (GSa/s)");
  }
  else if(isGasMixtureStudy){
    gr_bsl_summary_1cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
  }
  
  
  TCanvas *epc_summary_1cm = new TCanvas("epc_summary_1cm",Form("Epc 1 cm cell size Drift Tubes %s",energy_momentum.Data()),600,600);
  TCanvas *epc_summary_2cm = new TCanvas("epc_summary_2cm",Form("Epc %s cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()),600,600);
  ...
  gr_epc_summary_2cm->SetTitle(Form("Epc %s cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()));

  if(isScanAngleStudy){
    gr_epc_summary_2cm->GetXaxis()->SetTitle("Track angle (deg)");
  }
  else if(isScanHVStudy){
    gr_epc_summary_2cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
  }
  else if(isScanSamplingStudy){
    gr_epc_summary_2cm->GetXaxis()->SetTitle("Sampling Rate (GSa/s)");
  }
  else if(isGasMixtureStudy){
    gr_epc_summary_2cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
  }
  gr_epc_summary_2cm->GetYaxis()->SetTitle("Electrons per Cluster");
  gr_epc_summary_1cm->SetTitle(Form("Epc 1 cm cell size Drift Tubes %s",energy_momentum.Data()));
  ...
  if(isScanAngleStudy){
    ...
    gr_epc_summary_1cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
  }
  else if(isScanSamplingStudy){
    gr_epc_summary_1cm->GetXaxis()->SetTitle("Sampling Rate (GSa/s)");
  }
  else if(isGasMixtureStudy){
    gr_epc_summary_1cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
  }
  
  TCanvas *integral_summary_1cm = new TCanvas("integral_summary_1cm",Form("Integral 1 cm cell size Drift Tubes %s",energy_momentum.Data()),600,600);
  TCanvas *integral_summary_2cm = new TCanvas("integral_summary_2cm",Form("Integral %s cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()),600,600);
  ...
  gr_integral_summary_2cm->SetTitle(Form("Integral %s cm cell size Drift Tubes %s",tubes.Data(), energy_momentum.Data()));
  ...
  if(isScanAngleStudy){
    ...
    gr_integral_summary_2cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
  }
  else if(isScanSamplingStudy){
    gr_integral_summary_2cm->GetXaxis()->SetTitle("Sampling Rate (GSa/s)");
  }
  else if(isGasMixtureStudy){
    gr_integral_summary_2cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
  }
  gr_integral_summary_1cm->SetTitle(Form("Integral 1 cm cell size Drift Tubes %s",energy_momentum.Data()));

  if(isScanAngleStudy){
    gr_integral_summary_1cm->GetXaxis()->SetTitle("Track angle (deg)");
  }
  else if(isScanHVStudy){
    gr_integral_summary_1cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
  }
  else if(isScanSamplingStudy){
    gr_integral_summary_1cm->GetXaxis()->SetTitle("Sampling Rate (GSa/s)");
  }
  else if(isGasMixtureStudy){
    gr_integral_summary_1cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
  }
  gr_integral_summary_1cm->GetYaxis()->SetTitle("Charge (pC)");
  
  TCanvas *maximum_summary_1cm = new TCanvas("maximum_summary_1cm",Form("Maximum 1 cm cell size Drift Tubes %s",energy_momentum.Data()),600,600);
  TCanvas *maximum_summary_2cm = new TCanvas("maximum_summary_2cm",Form("Maximum %s cm cell size Drift Tubes %s",tubes.Data(), energy_momentum.Data()),600,600);
  ...
  gr_maximum_summary_2cm->SetTitle(Form("Maximum %s cm cell size Drift Tubes %s",tubes.Data(), energy_momentum.Data()));
  ...
  if(isScanAngleStudy){
    ...
    gr_maximum_summary_2cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
  }
  else if(isScanSamplingStudy){
    gr_maximum_summary_2cm->GetXaxis()->SetTitle("Sampling Rate (GSa/s)");
  }
  else if(isGasMixtureStudy){
    gr_maximum_summary_2cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
  }
  gr_maximum_summary_1cm->SetTitle(Form("Maximum 1 cm cell size Drift Tubes %s", energy_momentum.Data()));

  if(isScanAngleStudy){
    gr_maximum_summary_1cm->GetXaxis()->SetTitle("Track angle (deg)");
  }
  else if(isScanHVStudy){
    gr_maximum_summary_1cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
  }
  else if(isScanSamplingStudy){
    gr_maximum_summary_1cm->GetXaxis()->SetTitle("Sampling Rate (GSa/s)");
  }
  else if(isGasMixtureStudy){
    gr_maximum_summary_1cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
  }
  gr_maximum_summary_1cm->GetYaxis()->SetTitle("Voltage (V)");
  
  
  TCanvas *efficiency_electrons_1cm = new TCanvas("efficiency_electrons_1cm",Form("Number of Electrons Found 1 cm cell size Drift Tubes %s",energy_momentum.Data()),600,600);
  TCanvas *efficiency_electrons_2cm = new TCanvas("efficiency_electrons_2cm",Form("Number of Electrons Found %s cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()),600,600);
  ...
  TCanvas *efficiency_clusters_1cm = new TCanvas("efficiency_clusters_1cm",Form("Number of Clusters Found 1 cm cell size Drift Tubes %s",energy_momentum.Data()),600,600);
  TCanvas *efficiency_clusters_2cm = new TCanvas("efficiency_clusters_2cm",Form("Number of Clusters Found %s cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()),600,600);
  ...
  if(!isRatioSummaryPlots && !isEfficiencyPlot){
  gr_efficiency_electrons_2cm->SetTitle(Form("Number of Electrons Found %s cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()));
  gr_efficiency_clusters_2cm->SetTitle(Form("Number of Clusters Found %s cm cell size Drift Tubes %s",tubes.Data(), energy_momentum.Data()));
  gr_efficiency_electrons_1cm->SetTitle(Form("Number of Electrons Found 1 cm cell size Drift Tubes %s", energy_momentum.Data()));
  gr_efficiency_clusters_1cm->SetTitle(Form("Number of Clusters Found 1 cm cell size Drift Tubes %s",energy_momentum.Data()));
  }
  else if(isRatioSummaryPlots){
  gr_efficiency_electrons_2cm->GetYaxis()->SetTitle(Form("Number of Electrons Found %s cm/1 cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()));
  gr_efficiency_clusters_2cm->GetYaxis()->SetTitle(Form("Number of Clusters Found %s cm/1 cm cell size Drift Tubes %s",tubes.Data(), energy_momentum.Data()));
  gr_efficiency_electrons_2cm->GetYaxis()->SetTitle(Form("Number of Electrons Found %s cm/1 cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()));
  gr_efficiency_clusters_2cm->GetYaxis()->SetTitle(Form("Number of Clusters Found %s cm/1 cm cell size Drift Tubes %s",tubes.Data(), energy_momentum.Data()));
  }
  else if(isEfficiencyPlot){
	gr_efficiency_electrons_2cm->SetTitle(Form("Electrons Finding Efficiency %s cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()));
  gr_efficiency_clusters_2cm->SetTitle(Form("Clusters Finding Efficiency %s cm cell size Drift Tubes %s",tubes.Data(),energy_momentum.Data()));
  gr_efficiency_electrons_1cm->SetTitle(Form("Electrons Finding Efficiency 1 cm cell size Drift Tubes %s",energy_momentum.Data()));
  gr_efficiency_clusters_1cm->SetTitle(Form("Clusters Finding Efficiency 1 cm cell size Drift Tubes %s",energy_momentum.Data()));
  }
  ...
  if(isScanAngleStudy){
    ...
    gr_efficiency_electrons_2cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
    gr_efficiency_clusters_2cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
    gr_efficiency_electrons_1cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
    gr_efficiency_clusters_1cm->GetXaxis()->SetTitle("HV Configuration (Nom - 10V) to (Nom + 20V)");
  }
  else if(isScanSamplingStudy){
    ...
    gr_efficiency_electrons_2cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
    gr_efficiency_clusters_2cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
    gr_efficiency_electrons_1cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
    gr_efficiency_clusters_1cm->GetXaxis()->SetTitle("%(IsoB) in the He:IsoB Gas Mixture");
  }
  if(!isRatioSummaryPlots && !isEfficiencyPlot){
  gr_efficiency_electrons_2cm->GetYaxis()->SetTitle("Measured Average Number of Electrons ");
  gr_efficiency_clusters_2cm->GetYaxis()->SetTitle("Measured Average Number of Clusters");
  }
  else if(isRatioSummaryPlots){
	gr_efficiency_electrons_2cm->GetYaxis()->SetTitle(Form("Measured Average Number of Electrons Found Ratio %s cm/1 cm cell size Drift Tubes",tubes.Data()));
    gr_efficiency_clusters_2cm->GetYaxis()->SetTitle(Form("Measured Average Number of Clusters Found Ratio %s cm/1 cm cell size Drift Tubes",tubes.Data()));
  }
  else if(isEfficiencyPlot){
  ...
  gr_efficiency_electrons_1cm->GetYaxis()->SetTitle("Measured Average Number of Electrons ");
  gr_efficiency_clusters_1cm->GetYaxis()->SetTitle("Measured Average Number of Clusters");
  ...
  if(isInteractive){ // Deprecated option, to be updated
    ...
    while ((fscanf(fp, "%s", fname.Data() ) ) != -1){
	  ...
	  ///////////////////////////////////
		...
		string Runs_80_20[] = {"histosTB_run_40.root","histosTB_run_41.root","histosTB_run_42.root","histosTB_run_43.root"};
  		...
  		string Runs_85_15[] = {"histosTB_run_71.root","histosTB_run_64.root","histosTB_run_69.root","histosTB_run_70.root"};
  		...
  		string Runs_alpha_45[] = {"histosTB_run_43.root"}; // 2022 July Test Beam
  		string Runs_alpha_60[] = {"histosTB_run_46.root"}; // 2022 July Test Beam
		  string Nom_plus_20[] = {"histosTB_run_43.root"};
	  string Nom[] = {"histosTB_run_0.root"};
	  string Nom_minus_10[] = {"histosTB_run_0.root"};
	  string Nom_plus_10[] = {"histosTB_run_0.root"};
  	  //string Runs_80_20[] = {"histosTB_run_40.root","histosTB_run_41.root","histosTB_run_42.root","histosTB_run_43.root"};
  	  //string Runs_90_10[] = {"histosTB_run_54.root","histosTB_run_53.root","histosTB_run_55.root","histosTB_run_56.root"};
  	  //string Runs_85_15[] = {"histosTB_run_71.root","histosTB_run_64.root","histosTB_run_69.root","histosTB_run_70.root"};
	  // All Runs
	...
	//   string Nom[] = {"histosTB_run_62.root","histosTB_run_41.root", "histosTB_run_44.root","histosTB_run_58.root"};
    //   string Nom_minus_10[] = {"histosTB_run_0.root"};
	//   string Nom_plus_10[] = {"histosTB_run_0.root"};
	//   string Nom_plus_20[] = {"histosTB_run_0.root"};

	  ////////////////////////////////////////////////////////////////////////////////////////
	  // Scan Study for 80_20, 85/15, and 90/10 Gas Mixture Superimposed 45 Angle Track: HV 180 GeV//
	  //////////////////////////////////////////////////////////////////////////////////////
	//   string Runs_85_15[] = {"histosTB_run_64.root","histosTB_run_71.root","histosTB_run_69.root","histosTB_run_70.root"};
    //   string Runs_80_20[] = {"histosTB_run_40.root","histosTB_run_41.root","histosTB_run_42.root","histosTB_run_43.root"};
	//   string Runs_90_10[] = {"histosTB_run_54.root","histosTB_run_53.root","histosTB_run_55.root","histosTB_run_56.root"};
	//   string Runs_alpha_0[] = {"histosTB_run_44.root"}; // 2022 July Test Beam
  	//   string Runs_alpha_15[] = {"histosTB_run_0.root"}; // We didn't take data at 15°, 2022 July Test Beam
  	//   string Runs_alpha_30[] = {"histosTB_run_45.root"}; // 2022 July Test Beam
  	//   string Runs_alpha_45[] = {"histosTB_run_39.root","histosTB_run_40.root", "histosTB_run_41.root", "histosTB_run_42.root","histosTB_run_43.root","histosTB_run_9.root","histosTB_run_10.root","histosTB_run_63.root","histosTB_run_54.root","histosTB_run_53.root","histosTB_run_55.root","histosTB_run_56.root","histosTB_run_71.root","histosTB_run_65.root","histosTB_run_69.root","histosTB_run_70.root"}; // 2022 July Test Beam
  	//   string Runs_alpha_60[] = {"histosTB_run_46.root"}; // 2022 July Test Beam
	//   string Nom[] = {"histosTB_run_71.root", "histosTB_run_41.root","histosTB_run_53.root"};
    //   string Nom_minus_10[] = {"histosTB_run_64.root","histosTB_run_40.root","histosTB_run_54.root"};
	//   string Nom_plus_10[] = {"histosTB_run_69.root","histosTB_run_42.root","histosTB_run_55.root"};
	//   string Nom_plus_20[] = {"histosTB_run_70.root","histosTB_run_43.root","histosTB_run_56.root"};
	//////////////////////////////////////////////////////////////////////////////////////////
	...
	//    string Nom[] = {"histosTB_run_62.root","histosTB_run_71.root","histosTB_run_44.root" ,"histosTB_run_45.root", "histosTB_run_41.root", "histosTB_run_46.root","histosTB_run_11.root" ,"histosTB_run_51.root", "histosTB_run_10.root" ,"histosTB_run_47.root"};
    //    string Nom_minus_10[] = {"histosTB_run_0.root"};
	//    string Nom_plus_10[] = {"histosTB_run_0.root"};
	//    string Nom_plus_20[] = {"histosTB_run_0.root"};
	   //////////////////////////////////////////////////////////////////////////////////////////
	// Scan Study for 80_20, 85/15, and 90/10 Gas Mixture Superimposed Nom HV: Sampling Rate 180 GeV//
	/////////////////////////////////////////////////////////////////////////////////////////

	//    string Runs_85_15[] = {"histosTB_run_0.root"};
    //    string Runs_80_20[] = {"histosTB_run_0.root"};
	//    string Runs_90_10[] = {"histosTB_run_53.root", "histosTB_run_9.root" ,"histosTB_run_10.root"};
	//    string Runs_alpha_0[] = {"histosTB_run_0.root"}; // 2022 July Test Beam
  	//    string Runs_alpha_15[] = {"histosTB_run_0.root"}; // We didn't take data at 15°, 2022 July Test Beam
  	//    string Runs_alpha_30[] = {"histosTB_run_0.root","histosTB_run_0.root"}; // 2022 July Test Beam
  	//    string Runs_alpha_45[] = {"histosTB_run_53.root","histosTB_run_9.root","histosTB_run_10.root"}; // 2022 July Test Beam
  	//    string Runs_alpha_60[] = {"histosTB_run_0.root","histosTB_run_0.root"}; // 2022 July Test Beam
	//    string Nom[] = {"histosTB_run_53.root","histosTB_run_9.root","histosTB_run_10.root"};
    //    string Nom_minus_10[] = {"histosTB_run_0.root"};
	//    string Nom_plus_10[] = {"histosTB_run_0.root"};
	//    string Nom_plus_20[] = {"histosTB_run_0.root"};
    ...
    //   string Runs_alpha_0[] = {"histosTB_run_44.root"}; // 2022 July Test Beam
  	//   string Runs_alpha_15[] = {"histosTB_run_0.root"}; // We didn't take data at 15°, 2022 July Test Beam
  	//   string Runs_alpha_30[] = {"histosTB_run_45.root"}; // 2022 July Test Beam
  	//   string Runs_alpha_45[] = {"histosTB_run_39.root","histosTB_run_40.root", "histosTB_run_41.root", "histosTB_run_42.root","histosTB_run_43.root","histosTB_run_9.root","histosTB_run_10.root","histosTB_run_63.root","histosTB_run_54.root","histosTB_run_53.root","histosTB_run_55.root","histosTB_run_56.root","histosTB_run_71.root","histosTB_run_64.root","histosTB_run_69.root","histosTB_run_70.root"}; // 2022 July Test Beam
  	//   string Runs_alpha_60[] = {"histosTB_run_46.root"}; // 2022 July Test Beam
      //   }
	  int Nom_size = sizeof Nom / sizeof Nom[0];
      int Nom_minus_10_size =sizeof Nom_minus_10 / sizeof Nom_minus_10[0];
      int Nom_plus_10_size = sizeof Nom_plus_10 / sizeof Nom_plus_10[0];
      int Nom_plus_20_size = sizeof Nom_plus_20 / sizeof Nom_plus_20[0];
	...
	if (Nom[i] == name_file_compact) {
	  HV = HV.Append("HV Nominal");
	  cout << HV.Data() << endl;
	  isNom = 1;
	  highvoltage = 0;
	  printf("HV changed to Nominal +%d\n",highvoltage);
	  break;
	}
      }
	  for (int i = 0; i < Nom_minus_10_size; i++) {
	if (Nom_minus_10[i] == name_file_compact) {
	  HV = HV.Append("HV Nominal -10V");
	  cout << HV.Data() << endl;
	  isNom_minus_10 = 1;
	  highvoltage = -10;
	  printf("HV changed to Nominal %d\n",highvoltage);
	  ...
	  for (int i = 0; i < Nom_plus_10_size; i++) {
	if (Nom_plus_10[i] == name_file_compact) {
	  HV = HV.Append("HV Nominal +10V");
	  cout << HV.Data() << endl;
	  isNom_plus_10 = 1;
	  highvoltage = +10;
	  ...
	  for (int i = 0; i < Nom_plus_20_size; i++) {
	if (Nom_plus_20[i] == name_file_compact) {
	  HV = HV.Append("HV Nominal +20V");
	  cout << HV.Data() << endl;
	  isNom_plus_20 = 1;
	  highvoltage = +20;
	  printf("HV changed to Nominal +%d\n",highvoltage);
	...
	if (Runs_80_20[i] == name_file_compact) {
	  gasMixture = gasMixture.Append("He:IsoB 80/20");
	...
	if (Runs_90_10[i] == name_file_compact) {
	  gasMixture = gasMixture.Append("He:IsoB 90/10");
	  cout << gasMixture.Data() << endl;
	  isRuns_90_10 = 1;
	  percentageIsoB = 10;
	...
	if (Runs_85_15[i] == name_file_compact) {
	  gasMixture = gasMixture.Append("He:IsoB 85/15");
	  cout << gasMixture.Data() << endl;
	  isRuns_85_15 = 1;
	  percentageIsoB = 15;
	...
	mkdir(Form("Plots/%s/Waves/",fname.Data()), 0700);
	  ...
	  TCanvas *ncluster_corrected_1cm= new TCanvas("ncluster_corrected_1cm","ncluster_corrected_1cm",3500,1500);
      TCanvas *ncluster_corrected_2cm= new TCanvas("ncluster_corrected_2cm","ncluster_corrected_1cm",3500,1500);
	 ...
	 // if Nov2021 Test Beam
      if(isNov2021TestBeam){
	ncluster_corrected_1cm->Divide(2,3);
	ncluster_corrected_2cm->Divide(2,2);
	...
	ncluster_corrected_1cm->Divide(2,4);
	ncluster_corrected_2cm->Divide(2,2);
	...
	if(isChannel_1cm){
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    maximum_1cm = maximum_1cm+ h17->GetMean();
	   rms_maximum_1cm = rms_maximum_1cm + (float)(h17->GetRMS());
	  }
	  //max->cd(2);
	  if (doFits){
	  h17->Fit("landau");
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    ...
	    rms_bsl_1cm = rms_bsl_1cm + (float)(h3->GetRMS());
	  }
	  gPad->SetLogy(0);
	  gPad->SetLogx(0);
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    ...
	    rms_electrons_1cm = rms_electrons_1cm + (float)(h4->GetRMS());
	  }
	  //h4->Fit("landau");
	  if(isLogarithm){
	    gPad->SetLogy(1);
	  ...
	  pt_1cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
	  ...
	  pt_1cm_alpha->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    mean_clusters_1cm = mean_clusters_1cm + h20->GetMean();
	     rms_clusters_1cm = rms_clusters_1cm + (float)(h20->GetRMS());
	  }
	  ...
	  pt_1cm_cluster->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    ...
	    rms_epc_1cm = rms_epc_1cm + (float)(h31->GetRMS());
	  }
	  ...
	  cluster_population_1cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
	...
	//   }
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    ...
	    rms_aveph_1cm = rms_aveph_1cm + (float)(h5->GetRMS());
	  }
	  h5->Draw("same");
	...
	//   h6->GetXaxis()->SetRangeUser(0.,90.);
	  ...
	  TF1 *fit_1cm=new TF1("fit_1cm","pol1",30,180.);     
	  prof_px1_1->Fit("fit_1cm","R");
	  //h40->Draw("colz");
	  gPad->Update();

	   if(isNov2021TestBeam) {ncluster_corrected_1cm->cd(i-3);}
	   else if(isJuly2022TestBeam) {ncluster_corrected_1cm->cd(counter_plots_1cm);}
	   TH1D* test_corrected_clust = new TH1D (Form("test_corrected_clust_ch%d",i),"test_corrected_clust",100,0.,100);
	   TH1D* hncluster_corrected_1cm_X = h40->ProjectionX();
	   TH1D* hncluster_corrected_1cm_Y = h40->ProjectionY();
	   cout << "Number of Bins :" << prof_px1_1->GetNbinsX() << endl;
	// //   double param_p0 = fit_1cm->GetParameter(0);
	// //   cout << "Channel " << i << endl;
	// //   cout << "Parameter 0 of the fit" << param_p0 << endl;
	// //   double param_p1 = fit_1cm->GetParameter(1);
	//   cout << "Parameter 1 of the fit" << param_p1 << endl;
	   
	   
	   for (int bin = 0; bin < prof_px1_1->GetNbinsX(); ++bin){
		// double tdrift = (float)(bin)*3.0+1.5;
		double tdrift = hncluster_corrected_1cm_X->GetBinCenter(bin);
		cout << "Tdrift :" << tdrift << endl;
	 	//   double param_p0 = 37.82;
	 	//   double param_p1 = -0.1022;
		 double param_p0 = fit_1cm->GetParameter(0);
	  	 double param_p1 = fit_1cm->GetParameter(1);
		 double entries_ncluster_at_tdrift = hncluster_corrected_1cm_Y->GetBinContent(bin);
		//    double ncluster_at_tdrift = bin*1+1.5;
		 double ncluster_at_tdrift = prof_px1_1->GetBinContent(bin);
		   cout << "Bin :"<< bin << "Entries" << entries_ncluster_at_tdrift << "Number corrected " << (ncluster_at_tdrift * (float)(param_p0 / (param_p0 + param_p1 * tdrift))) << "Ncluster_at_tdrift: " << ncluster_at_tdrift << "Tdrift :" << tdrift << endl;
		//    if(tdrift > 30. && tdrift < 180.){
			
		   for (int number=0; number<entries_ncluster_at_tdrift; ++number){
		   			test_corrected_clust->Fill(ncluster_at_tdrift * (float)(param_p0 / (param_p0 + param_p1 * tdrift)));
			   	}
		//    }
	   }
	   test_corrected_clust->GetYaxis()->SetTitle("Entries");
	   test_corrected_clust->GetXaxis()->SetTitle("Number of Cluster Corrected");
	     test_corrected_clust->Fit("gaus");
	  gPad->SetLogy(1);
	  test_corrected_clust->Draw("same");
	  gPad->Update();
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    ...
	    rms_integral_1cm = rms_integral_1cm + (float)(h12->GetRMS());
	  }
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    ...
	    rms_rms_1cm = rms_rms_1cm + (float)(h16->GetRMS());
	  }
	  h16->Draw("same");
	...
	if(isScanAngleStudy){
	  ...
	  TMarker *m = new TMarker(alpha,aveph_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	  m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
      m->Draw("sameAP");
	}
	else if(isScanHVStudy){
	  gr_aveph_summary_1cm->SetPoint(counter_filling_electrons_1cm,highvoltage,aveph_1cm);
	  TMarker *m = new TMarker(highvoltage,aveph_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	  m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
      m->Draw("sameAP");
	}
	else if(isGasMixtureStudy){
	  gr_aveph_summary_1cm->SetPoint(counter_filling_electrons_1cm,percentageIsoB,aveph_1cm);
	   TMarker *m = new TMarker(percentageIsoB,aveph_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	  m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
      m->Draw("sameAP");
	}
	  ...
	  gr_aveph_summary_1cm->SetPoint(counter_filling_electrons_1cm,_gsample,aveph_1cm);
	   TMarker *m = new TMarker(_gsample,aveph_1cm,24);
     m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	  m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
      m->Draw("sameAP");
	}
	...
	gr_aveph_summary_1cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	//gr_aveph_summary_1cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_aveph_summary_1cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	TLatex *latex_aveph_summary_1cm = new TLatex(gr_aveph_summary_1cm->GetX()[number_of_trials], gr_aveph_summary_1cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_aveph_summary_1cm->SetTextSize(0.03); 
	latex_aveph_summary_1cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_aveph_summary_1cm->GetListOfFunctions()->Add(latex_aveph_summary_1cm);
	gr_aveph_summary_1cm->Draw("");
	...
	TMarker *m = new TMarker(alpha,rms_1cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isScanHVStudy){
	  gr_rms_summary_1cm->SetPoint(counter_filling_electrons_1cm,highvoltage,rms_1cm_var);
	  TMarker *m = new TMarker(highvoltage,rms_1cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isGasMixtureStudy){
	  gr_rms_summary_1cm->SetPoint(counter_filling_electrons_1cm,percentageIsoB,rms_1cm_var);
	   TMarker *m = new TMarker(percentageIsoB,rms_1cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	...
	gr_rms_summary_1cm->SetPoint(counter_filling_electrons_1cm,_gsample,rms_1cm_var);
	 TMarker *m = new TMarker(_gsample,rms_1cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	} 
	gr_rms_summary_1cm->SetPointError(counter_filling_electrons_1cm,0.,rms_rms_1cm);
	gr_rms_summary_1cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	gr_rms_summary_1cm->SetMarkerSize(0.5);
	//gr_rms_summary_1cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_rms_summary_1cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	TLatex *latex_rms_summary_1cm = new TLatex(gr_rms_summary_1cm->GetX()[number_of_trials], gr_rms_summary_1cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_rms_summary_1cm->SetTextSize(0.03); 
	latex_rms_summary_1cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	...
	if(isScanAngleStudy){
	  ...
	  TMarker *m = new TMarker(alpha,epc_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if( isGasMixtureStudy){
	  gr_epc_summary_1cm->SetPoint(counter_filling_electrons_1cm,percentageIsoB,epc_1cm);
	  TMarker *m = new TMarker(percentageIsoB,epc_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isScanHVStudy){
	  gr_epc_summary_1cm->SetPoint(counter_filling_electrons_1cm,highvoltage,epc_1cm);
	  TMarker *m = new TMarker(highvoltage,epc_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	  ...
	  gr_epc_summary_1cm->SetPoint(counter_filling_electrons_1cm,_gsample,epc_1cm);
	   TMarker *m = new TMarker(_gsample,epc_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	gr_epc_summary_1cm->SetPointError(counter_filling_electrons_1cm,0.,rms_epc_1cm);
	gr_epc_summary_1cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	gr_epc_summary_1cm->SetMarkerSize(0.5);
	//gr_epc_summary_1cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_epc_summary_1cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	TLatex *latex_epc_summary_1cm = new TLatex(gr_epc_summary_1cm->GetX()[number_of_trials], gr_epc_summary_1cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_epc_summary_1cm->SetTextSize(0.03); 
	latex_epc_summary_1cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_epc_summary_1cm->GetListOfFunctions()->Add(latex_epc_summary_1cm);
	gr_epc_summary_1cm->Draw("");
	...
	if(isScanAngleStudy){
	  ...
	  TMarker *m = new TMarker(alpha,bsl_1cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
      m->Draw("sameAP");
	}
	else if(isScanHVStudy ){
	  gr_bsl_summary_1cm->SetPoint(counter_filling_electrons_1cm,highvoltage,bsl_1cm_var);
	  TMarker *m = new TMarker(highvoltage,bsl_1cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isGasMixtureStudy){
	  gr_bsl_summary_1cm->SetPoint(counter_filling_electrons_1cm,percentageIsoB,bsl_1cm_var);
	   TMarker *m = new TMarker(percentageIsoB,bsl_1cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	  ...
	  gr_bsl_summary_1cm->SetPoint(counter_filling_electrons_1cm,_gsample,bsl_1cm_var);
	   TMarker *m = new TMarker(_gsample,bsl_1cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	gr_bsl_summary_1cm->SetPointError(counter_filling_electrons_1cm,0.,rms_bsl_1cm);
	gr_bsl_summary_1cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	gr_bsl_summary_1cm->SetMarkerSize(0.5);
	//gr_bsl_summary_1cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_bsl_summary_1cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	TLatex *latex_bsl_summary_1cm = new TLatex(gr_bsl_summary_1cm->GetX()[number_of_trials], gr_bsl_summary_1cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_bsl_summary_1cm->SetTextSize(0.03); 
	latex_bsl_summary_1cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_bsl_summary_1cm->GetListOfFunctions()->Add(latex_bsl_summary_1cm);
	gr_bsl_summary_1cm->Draw("");
	...
	if(isScanAngleStudy){  
	  ...
	  TMarker *m = new TMarker(alpha,maximum_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isScanHVStudy ){
	  gr_maximum_summary_1cm->SetPoint(counter_filling_electrons_1cm,highvoltage,maximum_1cm);
	  TMarker *m = new TMarker(highvoltage,maximum_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isGasMixtureStudy){
	  gr_maximum_summary_1cm->SetPoint(counter_filling_electrons_1cm,percentageIsoB,maximum_1cm);
	   TMarker *m = new TMarker(percentageIsoB,maximum_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	  ...
	  gr_maximum_summary_1cm->SetPoint(counter_filling_electrons_1cm,_gsample,maximum_1cm);
	   TMarker *m = new TMarker(_gsample,maximum_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	gr_maximum_summary_1cm->SetPointError(counter_filling_electrons_1cm,0.,rms_maximum_1cm);
	gr_maximum_summary_1cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	gr_maximum_summary_1cm->SetMarkerSize(0.5);
	//gr_maximum_summary_1cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_maximum_summary_1cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	TLatex *latex_maximum_summary_1cm = new TLatex(gr_maximum_summary_1cm->GetX()[number_of_trials], gr_maximum_summary_1cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_maximum_summary_1cm->SetTextSize(0.03); 
	latex_maximum_summary_1cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_maximum_summary_1cm->GetListOfFunctions()->Add(latex_maximum_summary_1cm);
	gr_maximum_summary_1cm->Draw("");
	...
	if(isScanAngleStudy){
	  ...
	  TMarker *m = new TMarker(alpha,integral_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isScanHVStudy ){
	gr_integral_summary_1cm->SetPoint(counter_filling_electrons_1cm,highvoltage,integral_1cm);
	TMarker *m = new TMarker(highvoltage,integral_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isGasMixtureStudy){
	gr_integral_summary_1cm->SetPoint(counter_filling_electrons_1cm,percentageIsoB,integral_1cm);
	 TMarker *m = new TMarker(percentageIsoB,integral_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	  ...
	  gr_integral_summary_1cm->SetPoint(counter_filling_electrons_1cm,_gsample,integral_1cm);
	   TMarker *m = new TMarker(_gsample,integral_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	gr_integral_summary_1cm->SetPointError(counter_filling_electrons_1cm,0.,rms_integral_1cm);
	gr_integral_summary_1cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	gr_integral_summary_1cm->SetMarkerSize(0.5);
	//gr_integral_summary_1cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_integral_summary_1cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	TLatex *latex_integral_summary_1cm = new TLatex(gr_integral_summary_1cm->GetX()[number_of_trials], gr_integral_summary_1cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_integral_summary_1cm->SetTextSize(0.03); 
	latex_integral_summary_1cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_integral_summary_1cm->GetListOfFunctions()->Add(latex_integral_summary_1cm);
	gr_integral_summary_1cm->Draw("");
	...
	if(isScanAngleStudy){
	  ...
	  TMarker *m = new TMarker(alpha,mean_electrons_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isScanHVStudy){
	  gr_efficiency_electrons_1cm->SetPoint(counter_filling_electrons_1cm,highvoltage,mean_electrons_1cm);
	  TMarker *m = new TMarker(highvoltage,mean_electrons_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isGasMixtureStudy){
	  gr_efficiency_electrons_1cm->SetPoint(counter_filling_electrons_1cm,percentageIsoB,mean_electrons_1cm);
	   TMarker *m = new TMarker(percentageIsoB,mean_electrons_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	  ...
	  gr_efficiency_electrons_1cm->SetPoint(counter_filling_electrons_1cm,_gsample,mean_electrons_1cm);
	   TMarker *m = new TMarker(_gsample,mean_electrons_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	gr_efficiency_electrons_1cm->SetPointError(counter_filling_electrons_1cm,0.,rms_electrons_1cm);
	gr_efficiency_electrons_1cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	gr_efficiency_electrons_1cm->SetMarkerSize(0.5);
	//gr_efficiency_electrons_1cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_efficiency_electrons_1cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	TLatex *latex_efficiency_electrons_1cm = new TLatex(gr_efficiency_electrons_1cm->GetX()[number_of_trials], gr_efficiency_electrons_1cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_efficiency_electrons_1cm->SetTextSize(0.03); 
	latex_efficiency_electrons_1cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_efficiency_electrons_1cm->GetListOfFunctions()->Add(latex_efficiency_electrons_1cm);
	gr_efficiency_electrons_1cm->Draw("");
	...
	if(isScanAngleStudy){
	  ...
	  TMarker *m = new TMarker(alpha,mean_clusters_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isScanHVStudy ){
	  gr_efficiency_clusters_1cm->SetPoint(counter_filling_clusters_1cm,highvoltage,mean_clusters_1cm);
	  TMarker *m = new TMarker(highvoltage,mean_clusters_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isGasMixtureStudy){
	  gr_efficiency_clusters_1cm->SetPoint(counter_filling_clusters_1cm,percentageIsoB,mean_clusters_1cm);
	   TMarker *m = new TMarker(percentageIsoB,mean_clusters_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	  ...
	  gr_efficiency_clusters_1cm->SetPoint(counter_filling_clusters_1cm,_gsample,mean_clusters_1cm);
	   TMarker *m = new TMarker(_gsample,mean_clusters_1cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	gr_efficiency_clusters_1cm->SetPointError(counter_filling_clusters_1cm,0.,rms_clusters_1cm);
	gr_efficiency_clusters_1cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	gr_efficiency_clusters_1cm->SetMarkerSize(0.5);
	//gr_efficiency_clusters_1cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_efficiency_clusters_1cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	TLatex *latex_efficiency_clusters_1cm = new TLatex(gr_efficiency_clusters_1cm->GetX()[number_of_trials], gr_efficiency_clusters_1cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_efficiency_clusters_1cm->SetTextSize(0.03); 
	latex_efficiency_clusters_1cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_efficiency_clusters_1cm->GetListOfFunctions()->Add(latex_efficiency_clusters_1cm);
	gr_efficiency_clusters_1cm->Draw("");
	...
	if((isChannel_2cm && isNov2021TestBeam) || (isChannel_1p5cm && isJuly2022TestBeam)){
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    ...
	    rms_maximum_2cm = rms_maximum_2cm + (float)(h17->GetRMS());
	  }
	  //max->cd(2);
	  if(doFits){
	  h17->Fit("landau");}
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    ...
	    rms_bsl_2cm = rms_bsl_2cm + (float)(h3->GetRMS());
	  }
	  gPad->SetLogy(0);
	  gPad->SetLogx(0);
	  h3->GetXaxis()->SetRangeUser(-0.5,-0.4);
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    ...
	    rms_electrons_2cm = rms_electrons_2cm + (float)(h4->GetRMS());
	  }
	  //h4->Fit("landau");
	  if(isLogarithm){
	    gPad->SetLogy(1);
	  ...
	  pt_2cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
	  ...
	  pt_2cm_alpha->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    ...
	    rms_aveph_2cm = rms_aveph_2cm + (float)(h5->GetRMS());
	  }
	  h5->Draw("same");
	...
	//   h6->GetXaxis()->SetRangeUser(0.,200.);
	  ...
	  if(isNov2021TestBeam) {ncluster_corrected_2cm->cd(i-3);}
       else if(isJuly2022TestBeam) {ncluster_corrected_2cm->cd(counter_plots_1p5cm);}
       TH1D* test_corrected_clust = new TH1D (Form("test_corrected_clust_ch%d",i),"test_corrected_clust",100,0.,100);
       TH1D* hncluster_corrected_2cm_X = h40->ProjectionX();
       TH1D* hncluster_corrected_2cm_Y = h40->ProjectionY();
       cout << "Number of Bins :" << prof_px2_2->GetNbinsX() << endl;
       for (int bin = 0; bin < prof_px2_2->GetNbinsX(); ++bin){
        // double tdrift = (float)(bin)*3.0+1.5;
        double tdrift = hncluster_corrected_2cm_X->GetBinCenter(bin);
        cout << "Tdrift :" << tdrift << endl;
        //   double param_p0 = 37.82;
        //   double param_p1 = -0.1022;
         double param_p0 = fit_2cm->GetParameter(0);
         double param_p1 = fit_2cm->GetParameter(1);
         double entries_ncluster_at_tdrift = hncluster_corrected_2cm_Y->GetBinContent(bin);
        //    double ncluster_at_tdrift = bin*1+1.5;
         double ncluster_at_tdrift = prof_px2_2->GetBinContent(bin);
           cout << "Bin :"<< bin << "Entries" << entries_ncluster_at_tdrift << "Number corrected " << (ncluster_at_tdrift * (float)(param_p0 / (param_p0 + param_p1 * tdrift))) << "Ncluster_at_tdrift: " << ncluster_at_tdrift << "Tdrift :" << tdrift << endl;     
           for (int number=0; number<entries_ncluster_at_tdrift; ++number){
                    test_corrected_clust->Fill(ncluster_at_tdrift * (float)(param_p0 / (param_p0 + param_p1 * tdrift)));
                }
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    ...
	    rms_integral_2cm = rms_integral_2cm + (float)(h12->GetRMS());
	}
	  //integ->cd(3);
	  h12->Draw("same");
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    ...
	    rms_rms_2cm = rms_rms_2cm + (float)(h16->GetRMS());
	  }
	  h16->Draw("same");
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    ...
	    rms_clusters_2cm = rms_clusters_2cm + (float)(h20->GetRMS());
	  }
	   if(expected_cluster > 0.){
	     h20->Fit("gaus");
	   }
	  ...
	  pt_2cm_cluster->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
	  ...
	  if(isRuns_90_10 || (isRuns_80_20 && isJuly2022TestBeam && i>0) || (isRuns_80_20 && isNov2021TestBeam) || isRuns_85_15){
	    ...
	    rms_epc_2cm = rms_epc_2cm + (float)(h31->GetRMS());
	  }
	  //h31->GetXaxis()->SetRangeUser(0.,5.);
	  //h31->Fit("expo");
	  h31->Draw("same");
	  ...
	  cluster_population_2cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
	...
	aveph_2cm = aveph_2cm/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1 ));
	rms_aveph_2cm = rms_aveph_2cm/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1));
	
	epc_2cm = epc_2cm/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1 ));
	rms_epc_2cm = rms_epc_2cm/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1 ));
	
	integral_2cm = (integral_2cm/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1 )));
	rms_integral_2cm = (rms_integral_2cm/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1 )));
	
	bsl_2cm_var = bsl_2cm_var/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1 ));
	rms_bsl_2cm = rms_bsl_2cm/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1 ));
	
	rms_2cm_var = rms_2cm_var/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1 ));
	rms_rms_2cm = rms_rms_2cm/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1 ));
	
	mean_clusters_2cm = mean_clusters_2cm/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1));
	rms_clusters_2cm = rms_clusters_2cm/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1));
	
	cout <<"Mean" << mean_clusters_2cm <<"Track Angle"<< alpha << endl;
	mean_electrons_2cm = mean_electrons_2cm/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1 ));
	rms_electrons_2cm = rms_electrons_2cm/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1 ));
	
	maximum_2cm = maximum_2cm/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1));
	rms_maximum_2cm = rms_maximum_2cm/(float) ((isNov2021TestBeam) > 0 ? Channel_2cm_size : (Channel_1p5cm_size -1));
	
	if(!isRatioSummaryPlots && !isEfficiencyPlot){
	mean_clusters_2cm = mean_clusters_2cm;
	mean_electrons_2cm = mean_electrons_2cm;
	rms_clusters_2cm = rms_clusters_2cm;
	rms_electrons_2cm = rms_electrons_2cm;
	}
	else if(isRatioSummaryPlots){
	rms_clusters_2cm = (mean_clusters_2cm/mean_clusters_1cm)*sqrt(pow((float)(rms_clusters_2cm/mean_clusters_2cm),2)+pow((float)(rms_clusters_1cm/mean_clusters_1cm),2));
	rms_electrons_2cm = (mean_electrons_2cm/mean_electrons_1cm)*sqrt(pow((float)(rms_electrons_2cm/mean_electrons_2cm),2)+pow((float)(rms_electrons_1cm/mean_electrons_1cm),2));
	mean_clusters_2cm = mean_clusters_2cm/mean_clusters_1cm;
	mean_electrons_2cm = mean_electrons_2cm/mean_electrons_1cm;
	}
	else if(isEfficiencyPlot){
	...
	if(isScanAngleStudy){
	  ...
	  TMarker *m = new TMarker(alpha,aveph_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isScanHVStudy ){
	  gr_aveph_summary_2cm->SetPoint(counter_filling_electrons_2cm,highvoltage,aveph_2cm);
	  TMarker *m = new TMarker(highvoltage,aveph_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isGasMixtureStudy){
	  gr_aveph_summary_2cm->SetPoint(counter_filling_electrons_2cm,percentageIsoB,aveph_2cm);
	   TMarker *m = new TMarker(percentageIsoB,aveph_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	  ...
	  gr_aveph_summary_2cm->SetPoint(counter_filling_electrons_2cm,_gsample,aveph_2cm);
	   TMarker *m = new TMarker(_gsample,aveph_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	gr_aveph_summary_2cm->SetPointError(counter_filling_electrons_2cm,0.,rms_aveph_2cm);
	gr_aveph_summary_2cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	gr_aveph_summary_2cm->SetMarkerSize(0.5);
	//gr_aveph_summary_2cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_aveph_summary_2cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	TLatex *latex_aveph_summary_2cm = new TLatex(gr_aveph_summary_2cm->GetX()[number_of_trials], gr_aveph_summary_2cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_aveph_summary_2cm->SetTextSize(0.03); 
	latex_aveph_summary_2cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_aveph_summary_2cm->GetListOfFunctions()->Add(latex_aveph_summary_2cm);
	gr_aveph_summary_2cm->Draw("");
	...
	if(isScanAngleStudy){
	  ...
	  TMarker *m = new TMarker(alpha,rms_2cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isScanHVStudy ){
	  gr_rms_summary_2cm->SetPoint(counter_filling_electrons_2cm,highvoltage,rms_2cm_var);
	  TMarker *m = new TMarker(highvoltage,rms_2cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isGasMixtureStudy){
	  gr_rms_summary_2cm->SetPoint(counter_filling_electrons_2cm,percentageIsoB,rms_2cm_var);
	   TMarker *m = new TMarker(percentageIsoB,rms_2cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	  ...
	  gr_rms_summary_2cm->SetPoint(counter_filling_electrons_2cm,_gsample,rms_2cm_var);
	   TMarker *m = new TMarker(_gsample,rms_2cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	gr_rms_summary_2cm->SetPointError(counter_filling_electrons_2cm,0.,rms_rms_2cm);
	gr_rms_summary_2cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	gr_rms_summary_2cm->SetMarkerSize(0.5);
	//gr_rms_summary_2cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_rms_summary_2cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	TLatex *latex_rms_summary_2cm = new TLatex(gr_rms_summary_2cm->GetX()[number_of_trials], gr_rms_summary_2cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_rms_summary_2cm->SetTextSize(0.03); 
	latex_rms_summary_2cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_rms_summary_2cm->GetListOfFunctions()->Add(latex_rms_summary_2cm);
	gr_rms_summary_2cm->Draw("");
	...
	if(isScanAngleStudy){
	  ...
	  TMarker *m = new TMarker(alpha,epc_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isScanHVStudy ){
	  gr_epc_summary_2cm->SetPoint(counter_filling_electrons_2cm,highvoltage,epc_2cm);
	  TMarker *m = new TMarker(highvoltage,epc_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isGasMixtureStudy){
	  gr_epc_summary_2cm->SetPoint(counter_filling_electrons_2cm,percentageIsoB,epc_2cm);
	   TMarker *m = new TMarker(percentageIsoB,epc_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	  ...
	  gr_epc_summary_2cm->SetPoint(counter_filling_electrons_2cm,_gsample,epc_2cm);
	   TMarker *m = new TMarker(_gsample,epc_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	gr_epc_summary_2cm->SetPointError(counter_filling_electrons_2cm,0.,rms_epc_2cm);
	gr_epc_summary_2cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	gr_epc_summary_2cm->SetMarkerSize(0.5);
	//gr_epc_summary_2cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_epc_summary_2cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	TLatex *latex_epc_summary_2cm = new TLatex(gr_epc_summary_2cm->GetX()[number_of_trials], gr_epc_summary_2cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_epc_summary_2cm->SetTextSize(0.03); 
	latex_epc_summary_2cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_epc_summary_2cm->GetListOfFunctions()->Add(latex_epc_summary_2cm);
	gr_epc_summary_2cm->Draw("");
	...
	if(isScanAngleStudy){
	  ...
	  TMarker *m = new TMarker(alpha,bsl_2cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isScanHVStudy){
	  gr_bsl_summary_2cm->SetPoint(counter_filling_electrons_2cm,highvoltage,bsl_2cm_var);
	  TMarker *m = new TMarker(highvoltage,bsl_2cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isGasMixtureStudy){
	  gr_bsl_summary_2cm->SetPoint(counter_filling_electrons_2cm,percentageIsoB,bsl_2cm_var);
	   TMarker *m = new TMarker(percentageIsoB,bsl_2cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	  ...
	  gr_bsl_summary_2cm->SetPoint(counter_filling_electrons_2cm,_gsample,bsl_2cm_var);
	   TMarker *m = new TMarker(_gsample,bsl_2cm_var,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	gr_bsl_summary_2cm->SetPointError(counter_filling_electrons_2cm,0.,rms_bsl_2cm);
	gr_bsl_summary_2cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	gr_bsl_summary_2cm->SetMarkerSize(0.5);
	//gr_bsl_summary_2cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_bsl_summary_2cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	TLatex *latex_bsl_summary_2cm = new TLatex(gr_bsl_summary_2cm->GetX()[number_of_trials], gr_bsl_summary_2cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_bsl_summary_2cm->SetTextSize(0.03); 
	latex_bsl_summary_2cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_bsl_summary_2cm->GetListOfFunctions()->Add(latex_bsl_summary_2cm);
	gr_bsl_summary_2cm->Draw("");
	...
	if(isScanAngleStudy){
	  ...
	  TMarker *m = new TMarker(alpha,maximum_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isScanHVStudy){
	  gr_maximum_summary_2cm->SetPoint(counter_filling_electrons_2cm,highvoltage,maximum_2cm);
	  TMarker *m = new TMarker(highvoltage,maximum_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isGasMixtureStudy){
	  gr_maximum_summary_2cm->SetPoint(counter_filling_electrons_2cm,percentageIsoB,maximum_2cm);
	   TMarker *m = new TMarker(percentageIsoB,maximum_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	  ...
	  gr_maximum_summary_2cm->SetPoint(counter_filling_electrons_2cm,_gsample,maximum_2cm);
	   TMarker *m = new TMarker(_gsample,maximum_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	gr_maximum_summary_2cm->SetPointError(counter_filling_electrons_2cm,0.,rms_maximum_2cm);
	gr_maximum_summary_2cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	gr_maximum_summary_2cm->SetMarkerSize(0.5);
	//gr_maximum_summary_2cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_maximum_summary_2cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	TLatex *latex_maximum_summary_2cm = new TLatex(gr_maximum_summary_2cm->GetX()[number_of_trials], gr_maximum_summary_2cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_maximum_summary_2cm->SetTextSize(0.03); 
	latex_maximum_summary_2cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_maximum_summary_2cm->GetListOfFunctions()->Add(latex_maximum_summary_2cm);
	gr_maximum_summary_2cm->Draw("");
	...
	if(isScanAngleStudy){
	  ...
	  TMarker *m = new TMarker(alpha,integral_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isScanHVStudy ){
	  gr_integral_summary_2cm->SetPoint(counter_filling_electrons_2cm,highvoltage,integral_2cm);
	  TMarker *m = new TMarker(highvoltage,integral_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	  ...
	  gr_integral_summary_2cm->SetPoint(counter_filling_electrons_2cm,percentageIsoB,integral_2cm);
	   TMarker *m = new TMarker(percentageIsoB,integral_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	  ...
	  gr_integral_summary_2cm->SetPoint(counter_filling_electrons_2cm,_gsample,integral_2cm);
	   TMarker *m = new TMarker(_gsample,integral_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	gr_integral_summary_2cm->SetPointError(counter_filling_electrons_2cm,0.,rms_integral_2cm);
	gr_integral_summary_2cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	gr_integral_summary_2cm->SetMarkerSize(0.5);
	//gr_integral_summary_2cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_integral_summary_2cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	TLatex *latex_integral_summary_2cm = new TLatex(gr_integral_summary_2cm->GetX()[number_of_trials], gr_integral_summary_2cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_integral_summary_2cm->SetTextSize(0.03); 
	latex_integral_summary_2cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_integral_summary_2cm->GetListOfFunctions()->Add(latex_integral_summary_2cm);
	gr_integral_summary_2cm->Draw("");
	...
	if(isScanAngleStudy){
	  ...
	  TMarker *m = new TMarker(alpha,mean_electrons_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isScanHVStudy ){
	  gr_efficiency_electrons_2cm->SetPoint(counter_filling_electrons_2cm,highvoltage,mean_electrons_2cm);
	  TMarker *m = new TMarker(highvoltage,mean_electrons_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	else if(isGasMixtureStudy){
	  gr_efficiency_electrons_2cm->SetPoint(counter_filling_electrons_2cm,percentageIsoB,mean_electrons_2cm);
	  TMarker *m = new TMarker(percentageIsoB,mean_electrons_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}
	  ...
	  TMarker *m = new TMarker(_gsample,mean_electrons_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));;
       m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	  m->Draw("sameAP");
	}    
	...
	gr_efficiency_electrons_2cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	//gr_efficiency_electrons_2cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed)); Not working
	gr_efficiency_electrons_2cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	//gr_efficiency_electrons_2cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	TLatex *latex_efficiency_electrons_2cm = new TLatex(gr_efficiency_electrons_2cm->GetX()[number_of_trials], gr_efficiency_electrons_2cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_efficiency_electrons_2cm->SetTextSize(0.03); 
	latex_efficiency_electrons_2cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_efficiency_electrons_2cm->GetListOfFunctions()->Add(latex_efficiency_electrons_2cm);
//	gr_efficiency_electrons_2cm->Draw("sameAP");
	gr_efficiency_electrons_2cm->Draw("");
	...
	if(isScanAngleStudy){
	  ...
	  TMarker *m = new TMarker(alpha,mean_clusters_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
      m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
      m->Draw("sameAP");
	}
	else if(isScanHVStudy ){
	  gr_efficiency_clusters_2cm->SetPoint(counter_filling_clusters_2cm,highvoltage,mean_clusters_2cm);
	  TMarker *m = new TMarker(highvoltage,mean_clusters_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
      m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
      m->Draw("sameAP");
	}
	else if(isGasMixtureStudy){
	  gr_efficiency_clusters_2cm->SetPoint(counter_filling_clusters_2cm,percentageIsoB,mean_clusters_2cm);
	   TMarker *m = new TMarker(percentageIsoB,mean_clusters_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
      m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
      m->Draw("sameAP");
	}
	  ...
	  gr_efficiency_clusters_2cm->SetPoint(counter_filling_clusters_2cm,_gsample,mean_clusters_2cm);
	   TMarker *m = new TMarker(_gsample,mean_clusters_2cm,24);
      m->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
      m->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
      m->Draw("sameAP");
	}    
	gr_efficiency_clusters_2cm->SetPointError(counter_filling_clusters_2cm,0.,rms_clusters_2cm);
	gr_efficiency_clusters_2cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	
	gr_efficiency_clusters_2cm->SetMarkerSize(0.5);
	//gr_efficiency_clusters_2cm->SetMarkerColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_efficiency_clusters_2cm->SetLineColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	//gr_efficiency_clusters_2cm->SetMarkerStyle((isRuns_90_10) > 0 ? 20 : ((isRuns_80_20) > 0 ? 21 : 22));
	TLatex *latex_efficiency_clusters_2cm = new TLatex(gr_efficiency_clusters_2cm->GetX()[number_of_trials], gr_efficiency_clusters_2cm->GetY()[number_of_trials],Form("%s",gasMixture.Data())); 
	latex_efficiency_clusters_2cm->SetTextSize(0.03); 
	latex_efficiency_clusters_2cm->SetTextColor((isRuns_90_10) > 0 ? kBlue : ((isRuns_80_20) > 0 ? kViolet : kRed));
	gr_efficiency_clusters_2cm->GetListOfFunctions()->Add(latex_efficiency_clusters_2cm);
	gr_efficiency_clusters_2cm->Draw("");
//	gr_efficiency_clusters_2cm->Paint("sameAP");
