...
class read_data {
 public :
  ...
  virtual void     Loop(Char_t *name, Int_t Run_number=0,Int_t MidEv=0,Int_t eventn=-1, float _gsample = 1.2, float N_1 = 3.0,float N_2= 1.0, float N_3 = 0.5, float N_4=0.5, float bslnTimeInterval = 25, int _dim = 1024, float _scale_cut = 0.20);
