...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::WaveData*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("WaveData", ::WaveData::Class_Version(), "inc/./WaveData.h", 11,
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const unordered_map<unsigned short,vector<unsigned short> >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("unordered_map<unsigned short,vector<unsigned short> >", -2, "unordered_map", 102,
      ...
      ::ROOT::AddClassAlternate("unordered_map<unsigned short,vector<unsigned short> >","std::unordered_map<unsigned short, std::vector<unsigned short, std::allocator<unsigned short> >, std::hash<unsigned short>, std::equal_to<unsigned short>, std::allocator<std::pair<unsigned short const, std::vector<unsigned short, std::allocator<unsigned short> > > > >");
      return &instance;
   }
   // Static variable to force the class initialization
...
"/cvmfs/sft.cern.ch/lcg/releases/ROOT/v6.22.00-be0a0/x86_64-centos7-gcc10-opt/include/",
"/lustre/home/nicola/CentOS7/TestBeam2023_OSCAnalysis/ConversionCodeOSC/WaveData/",
0
    };
...
nullptr
    ...
    if (!isInitialized) {
      TROOT::RegisterModule("WaveDataDict",
        ...
        TriggerDictionaryInitialization_WaveDataDict_Impl, {}, classesHeaders, /*hasCxxModule*/false);
      isInitialized = true;
    }
  }
